...
public class DatabaseColumn {
	...
	public DatabaseColumn(TableName argTableName, String argName, String argDataType, int argLength, int argPrecision, int argScale, String argDomainName, boolean argNullable, DefaultValue argDefault) {
		super();
