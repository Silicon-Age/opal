...
public class MySQLColumn extends DatabaseColumn {
	...
	public MySQLColumn(MySQLTableName argTableName, String argName, String argDataType, int argLength, int argPrecision, int argScale, String argDomainName, boolean argNullable, DefaultValue argDefault, boolean argAutoIncrement, boolean argSigned) {
