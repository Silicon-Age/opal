...
public class SybaseColumn extends SQLServerColumn {
	public SybaseColumn(TableName argTableName, String argName, String argDataType, int argLength, int argPrecision, int argScale, boolean argNullable, DefaultValue argDefault, boolean argIdentity) {
		super(
			argTableName,
			argName,
			argDataType,
